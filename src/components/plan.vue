<template>
  <section class="bg-[#31427A] text-white py-16">
    <div class="container mx-auto">
      ...
      <div class="w-[90%] md:w-[80%] xl:w-[50%] mx-auto space-y-2">
        <h2 class="text-[30px] md:text-[40px] font-bold leading-[45px] text-left">
          Powerful features for powerful creators
        </h2>
        <p class="text-[16px] md:text-[20px] mb-8 text-left">Choose a plan that's right for you</p>
      </div>
      ...
      >
        ...
        >
          ...
          <div class="text-white mb-6 flex items-center gap-4">
            ...
            <p class="text-white text-[16px]">/ Month</p>
          </div>
          <button
